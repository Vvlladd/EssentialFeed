...
//
//  Created by Vlad Toma on 25.08.2024.
//
...
final class EssentialFeedEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchesFixedTestAccountData() {
        ...
        case let .failure(error)?:
            XCTFail("Expected successful imageFeed result, got \(error)")
        default:
            XCTFail("Expected successful imageFeed result, got no result instead")
        }
    }
